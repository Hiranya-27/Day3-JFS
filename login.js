...
export default function Login() {
  ...
  const handleValidation = () => {
    ...
    if (!vehno) {
      setVeh('Please Enter the Password!')
    }
    else
    {
        setVeh('')
    ...
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      <div style={{ display: 'flex', flexDirection: 'column', width: '100vw', height: '100vh', alignItems: 'center', backgroundColor: '#1e2125' }}>
        <div style={{ justifyContent: 'space-between', display: 'flex', flexDirection: 'row', width: '100%', marginTop: '2em' }}>
          {/* <img style={{ width: '4em', marginLeft: '2em' }} src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcREKa_-2Ani27lKPrm5CiccceskX2J1C_up_g&usqp=CAU' alt='Logo' /> */}
          {/* <span style={{ color: '#e9dfce', textDecoration: 'underline', fontStyle: 'italic', marginLeft: '2em', marginRight: '2em', fontSize: '2em' }}>LMS</span> */}
        </div>
