  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      <div style={{ display: 'flex', flexDirection: 'column', width: '100vw', height: '100%', alignItems: 'center', backgroundColor: '#1e2125' }}>
        ...
        <h1 style={{ color: '#e9dfce', fontStyle: 'italic', fontSize: '3em',marginLeft: '570px' }}>Registration Page</h1>
        ...
        <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', height: '100%', width: '100%', }}>
          <div style={{display:'flex',flexDirection:'column',height:'100%',marginLeft: '200px'}}>
          ...
          <input value={password}
            ...
            <select style={{fontStyle: 'italic', width: '21.3em', fontSize: '1em', padding: '0.7em', margin: '1em' }}>
            ...
            <label style={{color:'white',marginLeft:'1em'}}>Gender Proof</label>
            <input type='file'  placeholder='Gender' style={{color:'white',fontStyle: 'italic', width: '30em', fontSize: '1em', padding: '0.7em', margin: '1em',height:'4em' }}/>
            {/* <span style={{color:'red'}}>{alfiles}</span> */}

          </div>
          </div>

         <button onClick={handleValidation} type='submit' style={{ width: '15em', padding: '0.8em', backgroundColor: '#e9dfce', borderRadius: 10, fontStyle: 'italic', fontSize: '1em', marginTop: '1em',marginLeft: '40px' }}>Register</button>
